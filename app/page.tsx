    ...
    <div className="relative">
      ...
      <section className=" bg-mirageBlue py-[88px] lg:py-[100px]">
        <div className="max-w-[1110px] mx-auto px-[24px] md:px-[40px] xl:px-0">
          <div className="flex flex-col lg:flex-row items-center gap-[64px] lg:gap-[131px]">
            <div className="flex-1 flex flex-col items-center lg:items-start gap-[32px] w-[90%] md:w-[80%]">
              <h2 className="h3-big sm:h2 text-linkWaterWhite sm:text-linkWaterWhite text-center lg:text-start">
                Who we work with
              </h2>
              <p className="text-linkWaterWhite/80  sm:max-w-[80%] lg:max-w-full text-center lg:text-start">
                Today, millions of people around the world have successfully
                connected their accounts to apps they love using our API. We
                provide developers with the tools they need to create easy and
                accessible experiences for their users.
              </p>
              <button className="text-linkWaterWhite border-2 px-[32px] py-[15px] rounded-full font-bold">
                About Us
              </button>
            </div>
            <div className="flex-1 grid grid-cols-2 justify-items-center items-center tab:grid-cols-3  gap-x-[50px] md:gap-x-[62px] sm:gap-x-[62px] gap-y-[46px] w-[90%] md:w-[80%] order-first lg:order-none">
              {/* tesla logo */}
      ...
      <section className="pt-[80px] tab:pt-[100px] lg:pt-[150px] pb-[40px] lg:pb-[50px]">
        <div className="flex flex-col lg:flex-row items-center gap-[48px] lg:gap-[125px] mx-auto max-w-[1110px] px-[24px] md:px-[40px] xl:px-0">
          <div className="max-w-[80%]">
            <Image
              src="/assets/home/desktop/easy-to-implement.svg"
              alt="icon easy to implement"
              width={445}
              height={284}
              className="ma-w-[445px]"
            />
          </div>
          <div className="flex flex-col items-center lg:items-start gap-[24px] max-w-[450px] text-center lg:text-start">
            <h2 className="h3-big sm:h2">Easy to implement</h2>
            <p className="text-sanJualBlueLight">
      ...
      <section className="relative lg:h-[700px] flex items-center py-[40px] lg:py-[50px]">
        <Image
          src="/assets/shared/desktop/bg-pattern-circle.svg"
          alt="circle"
          width={780}
          height={780}
          className="hidden lg:block absolute right-[-350px] bottom-0 h-[700px] w-[700px]"
        />
        <div className="max-w-[1110px] mx-auto flex flex-col lg:flex-row items-center gap-[48px] lg:gap-[90px] px-[24px] md:px-[40px] xl:px-0">
          <div className="lg:flex-1 flex flex-col items-center lg:items-start gap-[24px] text-center lg:text-start max-w-[450px]">
            <h2 className="h3-big sm:h2">Simple UI & UX</h2>
            <p className="text-sanJualBlueLight">
              Our pre-built form is easy to integrate in your app or website’s
              checkout flow and designed to optimize conversion.{" "}
            </p>
          </div>
          <div className="lg:flex-1 max-w-[80%] order-first lg:order-none">
            <Image
              src="/assets/home/desktop/simple-ui.svg"
              alt=""
              width={600}
              height={800}
            />
