...
const socials = [
  { name: "Facebook", icon: "/assets/shared/desktop/facebook.svg", url: "" },
  { name: "Twitter", icon: "/assets/shared/desktop/twitter.svg", url: "" },
  { name: "Linkedin", icon: "/assets/shared/desktop/linkedin.svg", url: "" },
];

export default function Footer() {
  return (
    <footer className="py-[32px] bg-mirageBlue flex items-center">
      <div className="w-[1110px] mx-auto px-[24px] md:px-[40px] xl:px-0">
        <div className="flex flex-col tab:flex-row items-center gap-[40px] md:gap-[56px]">
          ...
          <div className="flex flex-col tab:flex-row items-center gap-[40px] tab:flex-1">
            <ul className="flex flex-col sm:flex-row items-center gap-[32px] tab:gap-[40px]">
              {links.map((link, index) => (
                <Link
                  key={index}
                  href={link.url}
                  className="text-linkWaterWhite/80 font-bold capitalize"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <ul className="flex items-center gap-[24px] tab:ml-auto">
              {socials.map(item => (
                <Link
                  key={item.name}
                  href={item.url}
